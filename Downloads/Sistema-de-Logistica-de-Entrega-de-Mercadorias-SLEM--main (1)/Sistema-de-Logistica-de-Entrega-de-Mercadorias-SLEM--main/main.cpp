...
void menuCalculo()
{
    ...
    do
    {
        ...
        case 2:
        {
            ...
            if (!encontrou)
                cout << "Nenhum veículo disponível.\n";
            break;
        }
        case 3:
            Pedido::listarPedidos();
...
int main()
{
    ...
    do
    {
        ...
        case 5:
            Local::salvarLocaisEmArquivoBinario();
            Veiculo::salvarVeiculosEmArquivoBinario();
            Pedido::salvarPedidosEmArquivoBinario();
            cout << endl
                 << "Backup realizado com sucesso!" << endl;
            break;

        case 6:
            Local::carregarLocaisDeArquivoBinario();
            Veiculo::carregarVeiculosDeArquivoBinario();
            Pedido::carregarPedidosDeArquivoBinario();
            cout << endl
                 << "Restauração realizada com sucesso!" << endl;
            break;
